...
import com.fayardev.regms.commentservice.service.grpc.GrpcCommentService;
...
public class GrpcConfig {
    ...
    private final GrpcCommentService grpcCommentService;
    ...
    public Server grpcServer() throws IOException {
        this.grpcServer = ServerBuilder.forPort(port).addService(grpcCommentService).build().start();
